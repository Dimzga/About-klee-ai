        ...
        try {
            ...
            try {
                ...
                if (user) {
                    ...
                    if (!isNumber(user.lastngaji)) user.lastngaji = new Date * 1
...
title: `© ɴᴀʜɪᴅᴀ - ᴍᴅ v5.0.3 (Public Bot)`,
            ...
            if (chat.welcome) {
                ...
                for (let user of participants) {
						...
						try {
                            ...
                            title: 'ɴᴀʜɪᴅᴀ - ᴍᴅ',
                            thumbnailUrl: pp,
                            sourceUrl: 'https://chat.whatsapp.com/DiwKEd4OFFN0Gd34feyQL9',
                            mediaType: 1,
                            renderLargerThumbnail: true
                            }}}, {quoted: null})
                        }
...
global.dfail = (type, m, conn) => {
    ...
    let msgg = {
       unreg: `🚩 *[ ${userss.warn} / 5 ]* verifikasi nomer kamu menggunakan nama dan umur, untuk memverifikasi 1 nomer whatsapp. silahkan gunakan salah satu cara verifikasi di bawah ini.\n\n*[ 1 / 2 ]* *Captcha Registration*\ngunakan perintah *.register <namamu>, umurmu* untuk mendapatkan kode captcha.\nexample : *.register ɴᴀʜɪᴅᴀ.7*\n\n*[ 2 / 2 ]* *Auto Registration*\ngunakan perintah *.verify* untuk otomatis memverifikasikan dirimu kedalam database ɴᴀʜɪᴅᴀ bot\nexample : *.verify*\n\n*notice* :\nmengabaikan pesan ini sebanyak *5x* kamu akan di banned dan di blokir ɴᴀʜɪᴅᴀ, untuk membuka banned dan blokir dikenakan biaya sebesar *Rp.5.000*`
    }[type]
    if (userss.warn >= 5) return conn.reply(m.isGroup ? m.sender : m.chat, Func.texted('bold', `🚩 [ ${userss.warn} / 5 ] : Kamu mengabaikan pesan verifikasi tapi tenang masih ada bot lain kok, banned thanks. (^_^)`), m).then(() => {
    userss.banned = true
    userss.warn = 0
    userss.code = ''
    userss.codeExpire = 0
...
title: 'ɴᴀʜɪᴅᴀ - Kawaii',
body: 'Version: 9.1.0',
thumbnailUrl: 'https://telegra.ph/file/31601aee3fdf941bebbc4.jpg',
mentionedJid: [m.sender], 
mediaType: 1,
renderLargerThumbnail: true
}}}).then(() => {
